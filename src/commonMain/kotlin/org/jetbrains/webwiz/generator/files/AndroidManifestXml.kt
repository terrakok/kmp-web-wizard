...
class AndroidManifestXml(val moduleName: String, val projectInfo: ProjectInfo) : ProjectFile {
    override val path = "$moduleName/src/androidMain/AndroidManifest.xml"
